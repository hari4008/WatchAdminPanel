...
import { deleteAddress, getAllAddress, updateAddress } from "src/RTK/Slice/addressSlice"
        ...
        Cell: row => {
            ...
            const { values, errors, touched, handleBlur,
                ...
                initialValues: {
                    ...
                    city: row.row.original.city,
                    dist: row.row.original.dist,
                    state: row.row.original.state,
                    pincode: row.row.original.pincode,
